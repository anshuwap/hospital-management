...
<html>
  ...
  <body>
	...
	<s:if test="patient.defaultDoctor.userId==#session.CurrentUser.userId">
	...
	<hr>
 	<s:form action="updatePatientComment" method="post" namespace="/">  		
 		<s:textfield name="patient.userId" label="PatientId"/>
 		...
 		<s:textfield name="patient.defaultDoctor.userId" label="DefaultDoctorId" />
	 ...
	 <s:if test="returnCode=='success'">           
        <hr>Comments operation <s:property value="returnCode" /><br/><br/> 
