  ...
  <body>
	...
	<hr>
	 ...
	 <s:if test="returnCode=='success'">           
        <hr>List visitation <s:property value="returnCode" /><br/><br/>
	 </s:if>
	 ...
	 <hr>	 
	 <a href="<%=path%>/linkSearchPastVisit.action">Return to search past visitation</a><br>
  </body>
</html>
